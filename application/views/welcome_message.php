					...
					<div class="row height justify-content-center align-items-center">
						<div class="col-lg-5">
							<div class="banner-content">
								<h1>Everything <br>You can imagine <br>is Inmotion</h1>
								<p class="text-white">inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards – especially in the workplace. That’s why it’s crucial that, as women.</p>
							</div>
						</div>
						<div class="col-lg-5">
							<div class="banner-video">
								<div class="overlay overlay-bg"></div>
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="assets/front/img/play-btn.png" alt=""></a>
		...
		<div class="main-wrapper">
			...
			<section class="project-area">
				<div class="container">
					<div class="row">
						<div class="col-md-4">
							<div class="single-project" style="background: url(assets/front/img/p1.jpg);">
								<div class="overlay overlay-content">
									<h4>Vector Illustration</h4>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have allowed humanity to create slimmer, more portable technology than</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="single-project" style="background: url(assets/front/img/p2.jpg);">
								<div class="overlay overlay-content">
									<h4>Vector Illustration</h4>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have allowed humanity to create slimmer, more portable technology than</p>
								</div>
						...
						<div class="col-md-4">
							<div class="single-project" style="background: url(assets/front/img/p3.jpg);">
								<div class="overlay overlay-content">
									<h4>Vector Illustration</h4>
									<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have allowed humanity to create slimmer, more portable technology than</p>
								</div>
					...
					<div class="row justify-content-end">
						<div class="col-lg-5">
							<div class="begining-content">
								<h2>From the part of beginning</h2>
